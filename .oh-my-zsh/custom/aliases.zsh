...
alias gs='git switch'
alias home='cd $HOME && clear && neofetch --ascii $HOME/.config/neofetch/lord-vader.txt'
...
alias querystart='cd $HOME/Projects/fulcrum-query/ && skaffold delete ; skaffold dev'
